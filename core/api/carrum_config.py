...
def getCarrumUserData() -> dict:
	...
	# 	"success": True,
	# 	"data": {
	# 		"id": "00e1e990-1f55-4910-b1be-fd021190fae0",
	# 		"name": "Sumit Kumar",
	# 		"userType": "ADMINISTRATOR",
	# 		"status": "active",
	# 		"autoDialerId": None,
	# 		"did": None,
	# 		"roles": [{"id": "ea69530e-edfd-49ff-b159-f03276614703", "name": "admin"}],
	# 		"hubs": [{"id": "779db382-859d-48ee-ba17-d90ffa91cf24", "name": "mumbai"}],
	# 		"defaultRole": {"id": "ea69530e-edfd-49ff-b159-f03276614703", "name": "admin"},
	# 		"defaultHub": {"id": "779db382-859d-48ee-ba17-d90ffa91cf24", "name": "mumbai"},
	# 		"lastLoginIdentityId": None,
	# 		"createdAt": "2026-03-17T13:44:53.994Z",
	# 		"updatedAt": "2026-03-17T13:47:07.359Z",
	# 		"chatwootCred": {
	# 			"email": "devops@carrum.co.in",
	# 			"token": "pgRj2VtwRZQQaHjXdz4LgCTd",
	# 			"agentId": 1,
	# 			"inboxId": 1,
	# 			"password": "56056@Abcd",
	# 			"pubSubToken": "FzQCAWTQ29XKM7vXUb8orgh1",
	# 		},
	# 		"frappeCred": {"username": "Administrator", "password": None},
	# 		"smartflowCred": None,
	# 		"isActive": True,
	# 		"incomingCallDetails": None,
	# 	},
	# 	"timestamp": "2026-04-03T15:51:20.599Z",
	# }
