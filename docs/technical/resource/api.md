...
| DocType | Overview | Routes |
|---|---|---|
| `CRM Lead` | [crm_lead/README.md](crm_lead/README.md) | [GET](crm_lead/get.md) · [POST](crm_lead/post.md) · [PUT](crm_lead/put.md) · [DELETE](crm_lead/delete.md) · [Methods](crm_lead/methods.md) |
| `Lead walkin done` | [lead_walkin_done/README.md](lead_walkin_done/README.md) | [GET](lead_walkin_done/get.md) · [POST](lead_walkin_done/post.md) · [PUT](lead_walkin_done/put.md) · [DELETE](lead_walkin_done/delete.md) |
